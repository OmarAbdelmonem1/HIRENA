...
export default function CompanySidebar() {
  ...
  return <aside className="admin-sidebar">
    <div className="sidebar-logo"><img src={logoFull} alt="HIRENA" className="sidebar-logo-image" /></div>
    <div className="sidebar-section"><p className="sidebar-title">COMPANY</p>
