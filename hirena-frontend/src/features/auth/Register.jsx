  ...
  return (
    <div className="auth-page">
      <div className="auth-visual">
        ...
        <div>
          <span className="hero-kicker">START YOUR JOURNEY</span>
          <h1>Your future is waiting.</h1>
          <p>
            Create your account in seconds. Complete your profile whenever you
            are ready.
          </p>
        </div>
      ...
      <div className="auth-card-wrap">
        <form className="auth-card" onSubmit={submit}>
          ...
          <span className="eyebrow">JOIN HIRENA</span>
          <h2>Create your account</h2>
          <p className="auth-intro">
            Start with your email and password. You can complete the rest of
            your profile later.
          </p>
